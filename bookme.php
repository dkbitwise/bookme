...
if (is_admin()) {
    ...
    function bookme_admin_enqueue()
    {
        ...
        $bookme_pages = array('bookme-dashboard','bookme-services', 'bookme-staff', 'bookme-bookings', 'bookme-appearance', 'bookme-custom-fields', 'bookme-customers', 'bookme-calender', 'bookme-payments', 'bookme-email', 'bookme-sms', 'bookme-coupons', 'bookme-settings');

		
        /*if (isset($_GET['page']) && in_array($_GET['page'], 'bookme-dashboard')) {
            ...
            wp_enqueue_script('ajax-script', plugins_url('/admin/assets/js/custom.js', __FILE__), array('jquery'));
            wp_localize_script('ajax-script', 'bookme_object', $bookme_jstext);
             
        }
        else */if (isset($_GET['page']) && in_array($_GET['page'], $bookme_pages)) {
...
function bookme_enqueue()
{
    ...
    wp_enqueue_script('bookme-ajax-script', plugins_url('/assets/js/custom.js', __FILE__), array('jquery'));
